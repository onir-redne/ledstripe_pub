#ifndef _LEDSTRIPETRANSCOLOR_H
#define _LEDSTRIPETRANSCOLOR_H
...
class LedStripeTransColor : protected LedStripeTrans
{
    friend class LedStripeCtl;

public:
    LedStripeTransColor() : LedStripeTransColor(PWM_DUTY_CYCLE) {}
    LedStripeTransColor(uint16_t a_duty_cycle) : LedStripeTransColor(0, 0, 0, 0, a_duty_cycle) {}
    LedStripeTransColor(uint16_t a_tr, uint16_t a_tg, uint16_t a_tb, uint32_t a_time_ms, uint16_t a_duty_cycle) : 
        LedStripeTransColor(0, 0, 0, a_tr, a_tg, a_tb, a_time_ms, a_duty_cycle) {}
    LedStripeTransColor(uint16_t a_r, uint16_t a_g, uint16_t a_b, uint16_t a_tr, uint16_t a_tg, uint16_t a_tb, uint32_t a_time_ms, uint16_t a_duty_cycle) :
        LedStripeTransColor(a_r, a_g, a_b, a_tr, a_tg, a_tb, a_time_ms, a_duty_cycle, FUN_LINEAR) {}
    LedStripeTransColor(uint16_t a_r, uint16_t a_g, uint16_t a_b, uint16_t a_tr, uint16_t a_tg, uint16_t a_tb, uint32_t a_time_ms, uint16_t a_duty_cycle, uint8_t a_fun) : 
